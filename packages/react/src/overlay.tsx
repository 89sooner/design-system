...
const DialogContent = forwardRef<HTMLDivElement, DialogContentProps>(
  function DialogContent({ children, className, size = "md", ...props }, ref) {
    return (
      <RadixDialog.Portal>
...
const DialogClose = forwardRef<HTMLButtonElement, RadixDialog.DialogCloseProps>(
...
const DrawerClose = forwardRef<HTMLButtonElement, RadixDialog.DialogCloseProps>(
  function DrawerClose({ asChild = false, className, ...props }, ref) {
    return (
      <RadixDialog.Close
        {...props}
        ref={ref}
    ...
    return (
      <RadixTooltip.Portal>
        ...
        >
          {children}
          {showArrow ? (
            <RadixTooltip.Arrow className="cdt-tooltip__arrow" />
          ) : null}
        </RadixTooltip.Content>
      </RadixTooltip.Portal>
    );
...
const DropdownMenuItem = forwardRef<HTMLDivElement, DropdownMenuItemProps>(
  function DropdownMenuItem(
    ...
    return (
      ...
      >
        {icon === undefined ? null : (
          <span className="cdt-menu__item-icon" aria-hidden="true">
            {icon}
          </span>
        )}
        {children}
