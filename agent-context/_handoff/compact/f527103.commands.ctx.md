...
@kv sha256=4f3b8ca1395a03ac69b27a1a43a948e00636c764a48da1b481fe1c77c639dfdc bytes=8135 lines=193 title=명령어-/-테스트-결과-/-실패한-것과-원인
...
@p 마지막 실행 결과 (2026-07-10)
@code lang=text sha=26aef78bb82f lines=5 kept=5
...
@p 클린 체크아웃 실행 결과 (생성 파일 + 전체 dist/ 삭제 후)
@code lang=text sha=c838aca9ee56 lines=7 kept=7
|lint             exit=0
|lint:deps        exit=0
...
@h2 저장소 상태
@p git repo가 아니다. 모든 코드가 작업 트리에 미커밋 상태다. git init + 커밋은 사용자 승인 필요.
@p 커밋할 때의 규약:
